...
<head>
  ...
  <link rel="stylesheet" href="css/barrapesquisaimagems.css" />
    ...
    $(document).ready(function() {
      function realizarPesquisa() {
                ...
                .done(function(response) {
                    ...
                    window.location.href = 'resposta_da_imagem.php?pesquisa=' + encodeURIComponent(pesquisa);
                })
...
<i class="uil uil-search search-icon" id="searchIcon"></i>
  ...
  <h2><select id="categoria-select-imagem">
...
<div class="publicacao-imagem <?php echo $classeCategoria ?>">
              <div class="card">
                ...
                <div class="card-header">
                  ...
                  <img src='php/upload_post/<?php echo $id; ?>/<?php echo $arquivo; ?>' class="postagem" alt='Imagem' width='250px' data-toggle="modal" data-bs-toggle="tooltip" title="Clique para deixar em tela cheia" data-target="#visualizar" ><br>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p></p>
          <ul>
            <li><button type="button" class="btn btn-primary" data-dismiss="modal" data-toggle="modal">Voltar</button></li>
          </ul>
        </div>
      </div>
