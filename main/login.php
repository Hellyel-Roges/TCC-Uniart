...
<div class="linha">
  <div class="column" id="esquerda">
    <div class="header">
      ...
      <h4 class="animation a2">Unindo sua criatividade em um só lugar</h4>
    </div>
    <div class="form">
      <input type="text" id="login" class="form-field animation a3" placeholder="Login">
      <input type="password" id="senha" class="form-field animation a4" placeholder="Senha">
      <br>
      <p class="animation a5"><a href="esqueceusenha.php">Esqueceu a senha?</a> <a href="cadastro.php">Não tem uma conta?</a></p>
      <button class="animation a7" id="validar">Entrar</button>
